...
public class _03_Java2DArrayList {
    ...
    public static void dersOrtVeGecenMikBul(ArrayList< ArrayList<Integer> > notlarListesi, int dersNo){
     ...
     /*  ArrayList<ArrayList<Integer>> Matematik=new ArrayList<>();

        Matematik.add(matNotlari);
        //Collections.replaceAll(Matematik,[],"")
        System.out.println("Matematik = " + Matematik);

        ArrayList<ArrayList<Integer>> Fizik=new ArrayList<>();
        Fizik.add(fizikNotlari);

        System.out.println("Fizik = " + Fizik);
        ArrayList<ArrayList<Integer>> Kimya=new ArrayList<>();

        Kimya.add(kimyaNotlari);

        System.out.println("Kimya = " + Kimya.remove(0));*/
