...
/*
    ...
    public static void main(String[] args) {
        ...
        mus1.name="Emrah Guney";

        mus1.elektrikHesabi=new ElektrikHesabi();   //elektrik hesabi bir nesne oldugu icin her zaman nesneleri new ile olusturmamiz gerekir
        mus1.elektrikHesabi.tuketimEkle(50);
        mus1.elektrikHesabi.tuketimEkle(60);
        mus1.elektrikHesabi.tuketimEkle(70);
        mus1.elektrikHesabi.toplamTuketimYaz(); // System.out.println("mus1.elektrikHesabi.toplamTuketim = " + mus1.elektrikHesabi.toplamTuketim); ayni anlam

        mus1.elektrikHesabi.faturaYaz(mus1.name);
        mus1.elektrikHesabi.aylikTuketim();
    }
}
//ArrayList:toplu birsey varsa onlari atip kullaniriz.