...
// ayın kaç gün sürdüğünü metod gerekiyor
        ...
        for(Aylar a:Aylar.values()){
            //System.out.println(a);//sadece ay isimlerini yazdirir
            System.out.println(a.ayNo+"-"+a.gunMiktar+"-"+a.ayAd);//a.ayAd yerine sadece 'a' yazsan yine aylarin adini yazar
        }
    }
}
