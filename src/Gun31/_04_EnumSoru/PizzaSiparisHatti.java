...
public class PizzaSiparisHatti {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch (secim){
                case 1://small ekle
                    Pizza sp=new Pizza(PizzaSize.SMALL);siparisler.add(sp);break;
                case 2://medium ekle
                    Pizza mp=new Pizza(PizzaSize.MEDIUM);siparisler.add(mp);break;
                case 3://large ekle
                     Pizza lp=new Pizza(PizzaSize.LARGE);siparisler.add(lp);break;
                case 4:siparislerYazdir(siparisler);
            }
        }while(secim <= 4);
    }
    ...
    public static void siparislerYazdir(ArrayList<Pizza> siparisler){
        int s=0,m=0,l=0;
